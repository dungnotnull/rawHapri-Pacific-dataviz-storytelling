...
export default function Part2Chart1() {
  ...
  return (
        <section id="part2-chart1" className="relative bg-foam px-6 py-28 md:px-16">
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-8">
        <div ref={containerRef} className="chart-paper rounded-lg p-3 sm:p-5 overflow-x-auto">
          <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} className="min-w-[560px]">
            <g transform={`translate(${MARGIN.left},${MARGIN.top})`}>
              ...
              {cleanWaterYears.map((yr) => (
                <text
                  ...
                  y={-6}
                  textAnchor="middle"
                  fill={yr === year ? "var(--brass-bright)" : "var(--ink-faint)"}
                  fontSize={10}
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {shortName(name)}
                      {val !== undefined && (
                        <tspan fill="var(--brass-bright)" dx={6}>
                          {val.toFixed(0)}%
                        </tspan>
                      )}
                    </text>
        ...
        <div className="mt-6 grid lg:grid-cols-[1fr_260px] gap-6 items-start">
          ...
          <div className="chart-paper rounded-lg p-4">
            ...
            <div className="max-h-[220px] overflow-y-auto pr-1 flex flex-col gap-0.5">
              {cleanWaterCountries.map((name) => (
                <button
                  key={name}
                  onMouseEnter={() => setHover(name)}
